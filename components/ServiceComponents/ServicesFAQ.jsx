...
const faqs = [
  {
    q: "Do I need to be home for the fitting?",
    a: "Yes — someone over 18 needs to be present throughout the fitting appointment.",
  },
  {
    q: "How long does fitting take?",
    a: "Most standard rooms take between 1 and 3 hours. Larger jobs or bay windows may take longer — we'll give you an estimate in advance.",
  },
  {
    q: "What if I'm not happy with the result?",
    a: "We offer a free revisit within 14 days of fitting if anything isn't right. Our 2-year workmanship guarantee covers any issues with the making or installation.",
  },
  {
    q: "Will you remove my old curtains?",
    a: "Yes — we'll take down your existing curtains and dispose of them for you as part of the fitting service, at no extra charge.",
  },
];
