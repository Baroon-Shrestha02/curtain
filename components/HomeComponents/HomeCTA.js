            ...
            >
              ...
              <div className="mt-10 flex flex-col gap-4 sm:flex-row">
                <a
                  ...
                  className="group inline-flex items-center justify-center gap-3 rounded-full bg-[#25D366] px-8 py-4 text-sm font-medium uppercase tracking-[0.18em] text-white transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl"
                >
